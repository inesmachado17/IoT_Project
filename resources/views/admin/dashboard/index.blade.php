...
<div class="row mt-5">
    <div class="col-4 offset-2">
        <div class="card h-100">
            ...
            <div class="card-body">
                <h5 class="card-title text-center">Níveis de fumaça</h5>
                <p class="card-text text-center mb-1">
                    <span class="h5">{{ $data['smoke']->value }} ºC</span>
                </p>
                <p class="text-muted text-center small">
                    {{ $data['smoke']->date }}
                </p>
    ...
    <div class="col-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text text-center mb-1">
                    <span class="h5">{!! $data['motion']->value == 0 ? '<i class="bi bi-person-check"></i>' : '<i class="bi bi-person-x"></i>' !!}</span>
                </p>
                <p class="text-muted text-center small">
                    {{ $data['motion']->date }}
                </p>
